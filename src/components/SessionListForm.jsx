...
export default function SessionListForm({ AddToSessionList, }) {
  ...
  // const listOfBooks = JSON.parse(localStorage.getItem('ALL_BOOK_LIST'))
  // // console.log(listOfBooks, ' === PARSE & GET')
  // // console.log(listOfBooks[0], ' === PARSE & GET FIRST ELEMENT')
  // // console.log(listOfBooks[0].title, ' === PARSE & GET FIRST ELEMENTS TITLE')
  // // console.log(listOfBooks[0].id, ' === PARSE & GET FIRST ELEMENTS ID')
  // const listToShow = []

  // const AllBooksShow = (listOfBooks) => {
  //   for (let i = 0; i < listOfBooks.length; i++) {
  //     const ListCopy = listOfBooks[i].title;
  //     SetListTitle(ListCopy)
  //     console.log(ListCopy);
  //     console.log(listTitle);
  //     // console.log(listOfBooks[i].id);
  //     // console.log(listOfBooks[i].title);
  //     // SetListTitle.push(listOfBooks[i].title)
  //   }
  // }
  // // AllBooksShow()
  ...
  return (
    <>
      ...
      <DarkBG style={{ display: showMainForm ? 'none' : 'block' }}>
        <ShowDiv style={{ display: showMainForm ? 'none' : 'block' }}>
